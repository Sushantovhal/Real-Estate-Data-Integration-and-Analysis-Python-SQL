...
try:
    ...
    while True:
        ...
        LEFT JOIN TaxAssessor ta ON ta.Attom_Id__c = bp1.Attom_Id__c1
        WHERE ta.Attom_Id__c IS NULL AND bp1.sequence_no > {last_sequence_no}
        ...
        file_name = os.path.join(folder_path, f'BuildingPermit1({start_seq} to {end_seq}).csv')
